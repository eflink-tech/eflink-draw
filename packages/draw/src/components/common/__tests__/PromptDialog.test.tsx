...
describe('PromptDialog', () => {
  it('提交修改后的值', () => {
    ...
    const ok = Array.from(baseElement.querySelectorAll('button')).find((b) => b.textContent === '确定')
  ...
  it('取消回调', () => {
    ...
    const cancel = Array.from(baseElement.querySelectorAll('button')).find((b) => b.textContent === '取消')
